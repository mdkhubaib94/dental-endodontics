...
const PGDashboard = ({ brandTitleOverride }) => {
  ...
  // ‚úÖ Calendar helper functions for reschedule modal
  ...
  const submitRescheduleForBooking = async (bookingId) => {
    ...
    try {
      ...
      // If PG/UG ‚Äî backend returns requiresApproval: true (pending doctor approval)
        ...
        <div className="chief-topbar-left">
          ...
          <div className="chief-brand">
            ...
            <div className="chief-brand-title">
              ...
              {pgDepartmentLabel ? (
                <span className="chief-brand-title-dept">‚Äî {formatDepartmentLabel(pgDepartmentLabel)}</span>
              ) : null}
            </div>
          </div>
        </div>
        ...
        <div className="chief-topbar-right">
          ...
          <div className="user-profile-dropdown" ref={dropdownRef}>
            <div className="profile-button" onClick={toggleLogoutDropdown}>
              ...
              <div className="profile-arrow">{showLogoutDropdown ? '‚ñ≤' : '‚ñº'}</div>
            </div>
        ...
        {isSideNavOpen && (
          <aside className="chief-sidenav" aria-label="PG navigation">
            <div className="chief-sidenav-section">
              ...
              >
                <span className="chief-nav-icon">üßæ</span>
              ...
              >
                <span className="chief-nav-icon">üìå</span>
              ...
              >
                <span className="chief-nav-icon">üìÖ</span>
              ...
              >
                <span className="chief-nav-icon">üìä</span>
                <span>Analytics</span>
              </button>
            </div>
          </aside>
                  ...
                  <div className="general-case-preview-section" style={{ margin: '16px 0', padding: '12px 16px', background: '#f8fafc', borderRadius: 8, border: '1px solid #e2e8f0' }}>
                    ...
                    {generalCasePreviewLoading ? (
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 12 }}>
                        <div>
                          <div style={{ marginBottom: 4 }}><strong>Chief Complaint:</strong> {generalCasePreview.chiefComplaint || '‚Äî'}</div>
                          <div style={{ marginBottom: 4 }}><strong>Present Illness:</strong> {generalCasePreview.presentIllness || '‚Äî'}</div>
                          <div style={{ marginBottom: 4 }}><strong>Clinical Findings:</strong> {generalCasePreview.clinicalFindings || '‚Äî'}</div>
                          <div><strong>Final Diagnosis:</strong> {generalCasePreview.finalDiagnosis || generalCasePreview.provisionalDiagnosis || '‚Äî'}</div>
                        </div>
                        ...
                        {pgCaseSheetHistory.map((row, index) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <td style={{ whiteSpace: 'nowrap' }}>{createdAt ? formatDate(createdAt) : '‚Äî'}</td>
                              <td>{patientName || '‚Äî'}</td>
                              <td>{patientId || '‚Äî'}</td>
                              <td>{department || '‚Äî'}</td>
                              <td>
                              ...
                              <td style={{ whiteSpace: 'normal', wordBreak: 'break-word' }}>
                                {isPublicHealthDentistry ? '‚Äî' : (status === 'redo' ? (redoReason || approvalText || 'Redo requested by doctor.') : '‚Äî')}
                              </td>
                              <td>
                          ...
                          return (
                            <tr key={bookingId || `${appointment?.patientId}-${appointment?.appointmentDate}`} className="pg-assigned-row">
                              ...
                              <td
                                ...
                                title={appointment?.doctorName || appointment?.doctorId || '‚Äî'}
                              >
                                {appointment?.doctorName || appointment?.doctorId || '‚Äî'}
                              </td>
                              <td
                                style={{ padding: '6px 6px', textAlign: 'center', whiteSpace: 'normal', wordBreak: 'break-word' }}
                                title={appointment?.patientName || '‚Äî'}
                              >
                                {appointment?.patientName || '‚Äî'}
                              </td>
                              <td
                                style={{ padding: '6px 6px', textAlign: 'center', whiteSpace: 'nowrap' }}
                                title={appointment?.patientId || '‚Äî'}
                              >
                                {appointment?.patientId || '‚Äî'}
                              </td>
                              <td style={{ padding: '6px 6px', textAlign: 'center', whiteSpace: 'nowrap' }}>
                                {appointment?.appointmentDate || '‚Äî'}
                                {appointment?.appointmentTime ? ` ‚Ä¢ ${appointment.appointmentTime}` : ''}
                              </td>
                              <td
                                style={{ padding: '6px 6px', textAlign: 'center', whiteSpace: 'normal', wordBreak: 'break-word' }}
                              >
                                {formatAppointmentComplaintDisplay(appointment?.chiefComplaint) || '‚Äî'}
                              </td>
                              <td style={{ padding: '6px 6px', textAlign: 'center', whiteSpace: 'nowrap' }}>
      ...
      {activeRescheduleBookingId && rescheduleDrafts[activeRescheduleBookingId]?.open && (
        <div className="chief-overlay" onClick={() => cancelRescheduleForBooking(activeRescheduleBookingId)}>
          <div className="pg-reschedule-modal" onClick={(e) => e.stopPropagation()} style={{ maxHeight: '90vh', overflowY: 'auto' }}>
            ...
            <p>
              {activeRescheduleAppointment?.patientName || 'Patient'} ({activeRescheduleAppointment?.patientId || '‚Äî'})
            </p>
...
const PGDashboard = () => {
  ...
  const fetchPgAppointments = async () => {
    try {
      ...
      console.log('=Éˆ— DEBUG: API Response:', json);
      console.log('=Éˆ— DEBUG: Appointments array:', json.appointments);
      console.log('=Éˆ— DEBUG: Is array?', Array.isArray(json.appointments));
      console.log('=Éˆ— DEBUG: Length:', json.appointments?.length);
  ...
  const submitRescheduleForBooking = async (bookingId) => {
    ...
    try {
      ...
      // If PG/UG G«ˆ backend returns requiresApproval: true (pending doctor approval)
      if (json?.requiresApproval) {
        showMessage('Reschedule request submitted. Waiting for doctor approval.', 'success');
      } else {
        showMessage('Appointment rescheduled successfully.', 'success');
        ...
        <div className="chief-topbar-left">
          ...
          <div className="chief-brand">
            ...
            <div className="chief-brand-title">
              PG Dashboard
              {pgDepartmentLabel ? (
                <span className="chief-brand-title-dept">G«ˆ {formatDepartmentLabel(pgDepartmentLabel)}</span>
              ) : null}
            </div>
          </div>
        </div>
          ...
          <div className="user-profile-dropdown" ref={dropdownRef}>
            ...
            {showLogoutDropdown && (
              <div className="profile-dropdown-menu">
                ...
                <div className="dropdown-options">
                  <button className="dropdown-item" onClick={handleViewProfile} type="button">
                    <span className="dropdown-icon">=ÉÊÒ</span>
                    <span>My Profile</span>
                  </button>

                  <button className="dropdown-item" onClick={handleChangePassword} type="button">
                    <span className="dropdown-icon">=Éˆ∆</span>
                    <span>Change Password</span>
                  </button>
                  ...
                  <button
                    ...
                    type="button"
                  >
                    <span className="dropdown-icon">=É‹¨</span>
                    <span>Logout</span>
                  </button>
                </div>
              </div>
        ...
        {isSideNavOpen && (
          <aside className="chief-sidenav" aria-label="PG navigation">
            <div className="chief-sidenav-section">
              ...
              >
                <span className="chief-nav-icon">=É∫+</span>
                <span>Patient Management</span>
              </button>
              ...
              >
                <span className="chief-nav-icon">=ÉÙÓ</span>
                <span className="pg-nav-label">
                  Case Sheet
                  <span className="pg-nav-alert-dot" data-status={assignedCasesAlertStatus} />
                </span>
              ...
              >
                <span className="chief-nav-icon">=ÉÙ‡</span>
                <span>My Appointments</span>
              </button>
              ...
              >
                <span className="chief-nav-icon">=ÉÙË</span>
                <span>Analytics</span>
              </button>
            </div>
          </aside>
          ...
          <div className="doctor-dashboard-content">
            ...
            {activeView === 'patient' && (
              <div className="doctor-dashboard-content">
                ...
                {/* Patient Search G«ˆ ID / Phone / Name */}
                  ...
                  {searchResults.length > 0 && (
                    <div style={{
                      ...
                      {searchResults.map((p, i) => {
                        const fullName = [p.personalInfo?.firstName, p.personalInfo?.lastName].filter(Boolean).join(' ') || p.patientName || 'G«ˆ';
                        const phone = p.personalInfo?.phone || 'G«ˆ';
                        return (
                ...
                {showUserIdDisplay && (
                  <div className="general-case-preview-section" style={{ margin: '16px 0', padding: '12px 16px', background: '#f8fafc', borderRadius: 8, border: '1px solid #e2e8f0' }}>
                    ...
                    {generalCasePreviewLoading ? (
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr auto', gap: 12 }}>
                        <div>
                          <div style={{ marginBottom: 4 }}><strong>Chief Complaint:</strong> {generalCasePreview.chiefComplaint || 'G«ˆ'}</div>
                          <div style={{ marginBottom: 4 }}><strong>Present Illness:</strong> {generalCasePreview.presentIllness || 'G«ˆ'}</div>
                          <div style={{ marginBottom: 4 }}><strong>Clinical Findings:</strong> {generalCasePreview.clinicalFindings || 'G«ˆ'}</div>
                          <div><strong>Final Diagnosis:</strong> {generalCasePreview.finalDiagnosis || generalCasePreview.provisionalDiagnosis || 'G«ˆ'}</div>
                        </div>
                        <div style={{ textAlign: 'center', minWidth: 80 }}>
                          <div style={{ fontSize: 12, marginBottom: 4, color: '#64748b' }}>X-ray</div>
                          {String(generalCasePreview.xrayImage || '').trim() ? (
                ...
                {showForm && (
                  <div className="patient-form">
                    ...
                    {/* HPI, Past Medical History, Personal Habits, Medical History
                        G«ˆ hidden for Oral Medicine department (captured in the oral case sheet) */}
                      ...
                      <tbody>
                        {pgCaseSheetHistory.map((row, index) => {
                          ...
                          return (
                            ...
                            >
                              <td style={{ textAlign: 'center', whiteSpace: 'nowrap' }}>{index + 1}</td>
                              <td style={{ whiteSpace: 'nowrap' }}>{createdAt ? formatDate(createdAt) : 'G«ˆ'}</td>
                              <td>{patientName || 'G«ˆ'}</td>
                              <td>{patientId || 'G«ˆ'}</td>
                              <td>{department || 'G«ˆ'}</td>
                              <td>
                              ...
                              <td style={{ whiteSpace: 'normal', wordBreak: 'break-word' }}>
                                {status === 'redo' ? (redoReason || approvalText || 'Redo requested by doctor.') : 'G«ˆ'}
                              </td>
                              <td>
                                <div className="pg-assigned-action-buttons">
                                  <button
                    ...
                    <table className="pg-assigned-cases-table" style={{ fontSize: '0.8em', tableLayout: 'fixed', width: '100%' }}>
                      ...
                      <tbody>
                        {myUpcomingAppointments.map((appointment, index) => {
                          ...
                          // =Éˆ— FIX: Appointments are auto-confirmed when assigned
                          ...
                          return (
                            <tr key={bookingId || `${appointment?.patientId}-${appointment?.appointmentDate}`} className="pg-assigned-row">
                              ...
                              <td
                                style={{ padding: '6px 6px', textAlign: 'center', whiteSpace: 'nowrap' }}
                                title={appointment?.doctorName || appointment?.doctorId || 'G«ˆ'}
                              >
                                {appointment?.doctorName || appointment?.doctorId || 'G«ˆ'}
                              </td>
                              <td
                                style={{ padding: '6px 6px', textAlign: 'center', whiteSpace: 'normal', wordBreak: 'break-word' }}
                                title={appointment?.patientName || 'G«ˆ'}
                              >
                                {appointment?.patientName || 'G«ˆ'}
                              </td>
                              <td
                                style={{ padding: '6px 6px', textAlign: 'center', whiteSpace: 'nowrap' }}
                                title={appointment?.patientId || 'G«ˆ'}
                              >
                                {appointment?.patientId || 'G«ˆ'}
                              </td>
                              <td style={{ padding: '6px 6px', textAlign: 'center', whiteSpace: 'nowrap' }}>
                                {appointment?.appointmentDate || 'G«ˆ'}
                                {appointment?.appointmentTime ? ` G«Û ${appointment.appointmentTime}` : ''}
                              </td>
                              <td
                                style={{ padding: '6px 6px', textAlign: 'center', whiteSpace: 'normal', wordBreak: 'break-word' }}
                              >
                                {formatAppointmentComplaintDisplay(appointment?.chiefComplaint) || 'G«ˆ'}
                              </td>
                              <td style={{ padding: '6px 6px', textAlign: 'center', whiteSpace: 'nowrap' }}>
                                {/* =Éˆ— FIX: Show confirmation status */}
                                {isConfirmed ? (
                                  <span style={{ 
                                    background: '#48bb78', 
                                    color: '#fff', 
      ...
      {activeRescheduleBookingId && rescheduleDrafts[activeRescheduleBookingId]?.open && (
        <div className="chief-overlay" onClick={() => cancelRescheduleForBooking(activeRescheduleBookingId)}>
          <div className="pg-reschedule-modal" onClick={(e) => e.stopPropagation()} style={{ maxHeight: '90vh', overflowY: 'auto' }}>
            <h3>Reschedule Appointment</h3>
            <p>
              {activeRescheduleAppointment?.patientName || 'Patient'} ({activeRescheduleAppointment?.patientId || 'G«ˆ'})
            </p>
